...
@Component({
  selector: 'app-newrelease-info',
  templateUrl: './newrelease-info.component.html',
  styleUrls: ['./newrelease-info.component.css']
})
export class NewreleaseInfoComponent implements OnInit {
 file: File;
