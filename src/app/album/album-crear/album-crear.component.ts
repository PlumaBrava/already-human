...
// Lista de tracks en el album
 AlbumTracks=null;
  ...
  submitted = true;
  // error=null;
  error="error display must be null";
...
if(this.album.p_line!=null){
  ...
  // this.crearAlbumForm.value.title=this.album.title=,
  // // this.album.cover: this.crearAlbumForm.value.title,
  // this.crearAlbumForm.value.label_id= this.album. label_id= ,
  // this.crearAlbumForm.value.artist_id=this.album.artist_id,
  // this.crearAlbumForm.value.release_date=this.album. release_date,
  // this.album.p_line=this.crearAlbumForm.value.p_line=this.album.p_line,
  // this.album.c_line= this.crearAlbumForm.value.c_line=this.album.c_line,
  // this.album.explicit=this.crearAlbumForm.value.explicit=this.album.explicit,
  // this.crearAlbumForm.value.upc=this.album.upc=,
  // this.crearAlbumForm.value.genre=this.album.genre,
  // this.crearAlbumForm.value.album_genres=this.album. album_genres,
  // this.crearAlbumForm.value.album_territories=this.album.album_territories,
  // this.crearAlbumForm.value.language=this.album. language,
  // this.crearAlbumForm.value.secondary_language=this.album. secondary_language,
...
onSubmit() {
  ...
  let formData:FormData = new FormData();
        ...
        formData.append('album_territories',this.crearAlbumForm.value.album_territories);
        }
...
transformGenres(genres:string[]):any{
    ...
    // });
     ...
     console.log('transformGenres result',result);
    return result;
}
